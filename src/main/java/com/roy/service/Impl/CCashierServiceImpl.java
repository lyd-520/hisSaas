...
import com.roy.mapper.CCashierMapper;
import com.roy.service.CCashierService;
...
@Service
@Transactional
public class CCashierServiceImpl extends SaasService implements CCashierService {
    @Resource
