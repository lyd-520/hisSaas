...
import com.roy.mapper.CXiangmuPayMapper;
import com.roy.service.CXiangmuPayService;
...
@Service
@Transactional
public class CXiangmuPayServiceImpl extends SaasService implements CXiangmuPayService {
    @Resource
