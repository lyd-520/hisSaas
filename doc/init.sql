...
-- ----------------------------
-- Table structure for hospitalmeta
-- ----------------------------
DROP TABLE IF EXISTS `hospitalmeta`;
CREATE TABLE `hospitalmeta`  (
                                 `hospitalId` int(0) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
                                 `hospitalName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '医院名',
                                 `hospitalAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '医院地址',
                                 `mysqlUrl` varchar(127) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mysql地址',
                                 `mysqlSchema` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mysql库名',
                                 `mysqlUsername` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mysql用户名',
                                 `mysqlPassword` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT 'mysql密码',
                                 `mysqlStatus` int(0) DEFAULT NULL COMMENT '0-未建库;1-已建库',
                                 PRIMARY KEY (`hospitalId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of hospitalmeta
-- ----------------------------
INSERT INTO `hospitalmeta` VALUES (2, '人民医院', ',xx街道xx号,xx街道xx号', 'localhost:3306', 'renminghis', 'root', 'root', 1);
...
INSERT INTO `sys_menu` VALUES (92, 4, '医院基础信息维护', '../toHospitalManage', 0, NULL, '&#xe7ae;', 1);
